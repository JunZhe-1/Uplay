...
{
    /// <inheritdoc />
    public partial class Uplay : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UplayUserUserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vouchers", x => x.Voucher_ID);
                    table.ForeignKey(
                        name: "FK_Vouchers_UplayUsers_UplayUserUserId",
                        column: x => x.UplayUserUserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vouchers_UplayUserUserId",
                table: "Vouchers",
                column: "UplayUserUserId");
        }
